...
<div class="jumbotron" style="padding:10px">
	<div class="container">
		...
		<strong>KRAKÓW - 8.VI.2019</strong>  (sobota) - godz. 13 ul. Reymonta 20 (Stadion), Sala 1w014, I piętro</p>
		<p style="font-size:17px; background-color:red; color:white; font-family: verdana; padding: 6px 6px 6px 6px; margin-top: -2px; margin-bottom: 20px;">
		<strong>KATOWICE - 9.VI.2019</strong> (niedziela) - godz. 13 ul. Opolska 22, Sala A, I piętro</p>
