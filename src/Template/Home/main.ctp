...
<div class="jumbotron" style="padding:10px">
	<div class="container">
		...
		<p style="font-size:17px; background-color:red; color: #bbb; font-family: verdana; padding: 0px 6px; margin-top: -10px;">
		(WSHiT, skrzydło A, wejście po lewej stronie dziedzińca) - niedaleko dworca PKP Gdańsk Wrzeszcz.</p>
		<p style="font-size:17px; background-color:red; color:white; font-family: verdana; padding: 15px 6px 4px 6px; margin-top: -6px; margin-bottom: 20px;">
