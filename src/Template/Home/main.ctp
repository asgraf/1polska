...
<div class="jumbotron" style="padding:10px">
	<div class="container">
		...
		<p style="font-size:19px; color:red; font-family: verdana; margin-bottom: -2px; margin-top: -12px;"><b>KWW 1Polska - Ruch Oddolny zarejestrowany w PKW!</b> (za chwilę tu pojawi się do pobrania karta do zbiórki 100 000 podpisów)<a href="https://pkw.gov.pl/pliki/1565945628_wykaz_zawiadomien_34.pdf">wykaz komitetów PKW</a>  
