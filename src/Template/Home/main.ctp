...
<div class="jumbotron" style="padding:10px">
	<div class="container">
		...
		<p style="font-size:19px; color:red; font-family: verdana; margin-bottom: -2px; margin-top: -12px;"><b>KWW 1Polska - Ruch Oddolny zgłoszony w PKW!</b> (za chwilę pojawi się tu do pobrania karta do zbiórki 100000 podpisów)<a href="https://pkw.gov.pl/pliki/1565945628_wykaz_zawiadomien_34.pdf">wykaz komitetów PKW</a>  
