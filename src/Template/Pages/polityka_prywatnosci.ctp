 ...
 */
$this->set('title', 'Polityka prywatności');
?>
<h2>Polityka prywatności</h2>

<p>
	<br/>
	<strong>1Polska.pl jest prywatną, niekomercyjną stroną o charakterze społecznym - i powstała "pro publico
		bono".</strong><br/>
	<br/>
...
<h3><strong>Reprezentanci</strong></h3><br/>
	...
	- i nie odpowiada w żaden sposób za politykę prywatności ani praktyki tych (zewnętrznych) firm/serwisów
	internetowych.<br/>
